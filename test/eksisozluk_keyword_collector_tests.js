...
var EksiSozlukKeywordCollector = require('../eksisozluk_keyword_collector');
...
describe('EksiSozluk Keyword Collector finds pages with given term', function() {

  it('should throw an error if cursor info is not complete', function() {
    assert.throws(function() {
      var collector = new EksiSozlukKeywordCollector();
    }, Error);
  });

  it('should build search url', function() {
    var collector = new EksiSozlukKeywordCollector({cursor: {}});
  ...
  it('should return keyword list', function(done) {
    mockResult();
    var collector = new EksiSozlukKeywordCollector({cursor: {id: 'test content'}});
